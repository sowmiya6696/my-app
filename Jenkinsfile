node{
   ...
   sh "docker login -u admin -p admin123 43.204.32.230:8083"
   sh "docker tag sowmiya6696/myweb:0.0.2 43.204.32.230:8083/sowmiya:1.2.0"
   sh 'docker push 43.204.32.230:8083/sowmiya:1.2.0'
   }
